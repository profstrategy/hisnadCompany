...
const properties = [
  {
    ...
    mainImage: {
      id: 1,
      urls: ["https://804e39kyw6.ufs.sh/f/DSZcL8WoAVeGhf2l3FGTi2RxpoBaum0GzECyOL8I9Hf4sAcr"]
    },
    tier: 'Residential',
    status: 'Available',
  ...
  },
  {
    ...
    mainImage: {
      id: 2,
      urls: [
        "https://804e39kyw6.ufs.sh/f/DSZcL8WoAVeGhf2l3FGTi2RxpoBaum0GzECyOL8I9Hf4sAcr",
        "https://804e39kyw6.ufs.sh/f/DSZcL8WoAVeGPL3LD7XpsMga0KdchUGN1VSDWCYvPuTpIzHB"
      ]
    },
    tier: 'Farmland',
    status: 'Available',
    ...
    slug: "crestwood-green-acres",
    location: "Orile Oko Community, Ogun State",
    description: "Crestwood Green Acres, managed by Al-Hisnad Home and Property, offers investors a turnkey farmland investment opportunity in Orile-Oko community, Remo North, Ogun State. The model allows investors to purchase freehold farmland while our team handles end-to-end agribusiness management.",
  ...
  },
  {
    ...
    mainImage: {
      ...
      urls: [
        "https://804e39kyw6.ufs.sh/f/DSZcL8WoAVeGhf2l3FGTi2RxpoBaum0GzECyOL8I9Hf4sAcr",
        "https://804e39kyw6.ufs.sh/f/DSZcL8WoAVeGPL3LD7XpsMga0KdchUGN1VSDWCYvPuTpIzHB",
        "https://804e39kyw6.ufs.sh/f/DSZcL8WoAVeGxPO4cevnAmQwDxFdjHJBP6LVYXafCNbRehsr"
      ]
    },
    tier: 'Farmland',
    status: 'Available',
    ...
    description: "Freehold farmland along Lagos-Ibadan Expressway, Ikanna Balogun, Obafemi Owode local government, Ogun State with turnkey agribusiness management. Ideal for investors seeking 18-25% annual ROI through long-term and short-term cultivation.",
    category: "Agricultural Investment/Farmland",
    features: [
      "10% discount for bulk purchases",
      "Deed of Assignment",
...
async function main() {
  ...
  for (const property of properties) {
    ...
    const prismaData = {
      ...
      price: property.price.map(p => p.price),
